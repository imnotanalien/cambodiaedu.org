          ...
          (function () {
            var u =
                ("object" ==
                  ...
                  self.self === self &&
                  self) ||
                ("object" == (void 0 === r.g ? "undefined" : i(r.g)) &&
                  r.g.global === r.g &&
                  r.g) ||
                this ||
                {},
            ...
            t.nodeType
              ? (u._ = m)
              : (!n.nodeType && n.exports && (t = n.exports = m), (t._ = m)),
              (m.VERSION = "1.9.1");
            var b,
              w = function (n, t, r) {
            ...
            var x = function (n, t) {
                return (
                  ...
                  function () {
                    for (
                      var r = Math.max(arguments.length - t, 0),
                        e = Array(r),
                        i = 0;
                      i < r;
                      i++
            ...
            (m.reduce = m.foldl = m.inject = I(1)),
              (m.reduceRight = m.foldr = I(-1)),
              (m.find = m.detect =
                function (n, t, r) {
              ...
              (m.every = m.all =
                function (n, t, r) {
                  t = j(t, r);
                  for (
                    var e = !F(n) && m.keys(n), i = (e || n).length, u = 0;
                    u < i;
                    u++
                  ) {
                    var o = e ? e[u] : u;
              ...
              (m.max = function (n, t, r) {
                ...
                if (
                  null == t ||
                  ("number" == typeof t && "object" != i(n[0]) && null != n)
                )
                  for (
                    var c = 0, f = (n = F(n) ? n : m.values(n)).length;
                    c < f;
                    c++
                  )
                    null != (e = n[c]) && e > o && (o = e);
              ...
              (m.sample = function (n, t, r) {
                if (null == t || r)
                  return F(n) || (n = m.values(n)), n[m.random(n.length - 1)];
              ...
              (m.sortBy = function (n, t, r) {
                ...
                return (
                  ...
                  m.pluck(
                    m
                      .map(n, function (n, r, i) {
                        return { value: n, index: e++, criteria: t(n, r, i) };
                      })
                      .sort(function (n, t) {
                        var r = n.criteria,
                          e = t.criteria;
            ...
            var P = function n(t, r, e, i) {
              for (var u = (i = i || []).length, o = 0, a = E(t); o < a; o++) {
                ...
                if (F(c) && (m.isArray(c) || m.isArguments(c)))
                  if (r) for (var f = 0, l = c.length; f < l; ) i[u++] = c[f++];
            ...
            (m.flatten = function (n, t) {
                ...
                function (n, t, r, e) {
                  ...
                  for (var i = [], u = [], o = 0, a = E(n); o < a; o++) {
                    ...
                    t && !r
                      ? ((o && u === f) || i.push(c), (u = f))
                      : r
                      ? m.contains(u, f) || (u.push(f), i.push(c))
              ...
              (m.intersection = function (n) {
                for (
                  var t = [], r = arguments.length, e = 0, i = E(n);
                  e < i;
                  e++
                ) {
                  var u = n[e];
              ...
              (m.unzip = function (n) {
                for (
                  var t = (n && m.max(n, E).length) || 0, r = Array(t), e = 0;
                  e < t;
                  e++
                )
                  r[e] = m.pluck(n, e);
            ...
            var T = function (n, t, r) {
              return function (e, i, u) {
                ...
                if (i != i)
                  return (u = t(s.call(e, o, a), m.isNaN)) >= 0 ? u + o : -1;
            ...
            (m.indexOf = T(1, m.findIndex, m.sortedIndex)),
              ...
              (m.chunk = function (n, t) {
                ...
                for (var r = [], e = 0, i = n.length; e < i; )
                  r.push(s.call(n, e, (e += t)));
                return r;
              });
            ...
            (m.bind = x(function (n, t, r) {
              ...
              (m.partial = x(function (n, t) {
                ...
                return function e() {
                  for (var i = 0, u = t.length, o = Array(u), a = 0; a < u; a++)
                    o[a] = t[a] === r ? arguments[i++] : t[a];
                  for (; i < arguments.length; ) o.push(arguments[i++]);
                  return z(n, e, this, this, o);
                };
              })),
              (m.partial.placeholder = m),
              (m.bindAll = x(function (n, t) {
            ...
            var B = !{ toString: null }.propertyIsEnumerable("toString"),
              ...
              D = function (n, t) {
                var r = q.length,
                  ...
                  u = "constructor";
                for (_(n, u) && !m.contains(t, u) && t.push(u); r--; )
                  (u = q[r]) in n &&
                    n[u] !== i[u] &&
                    !m.contains(t, u) &&
                    t.push(u);
            ...
            (m.keys = function (n) {
              ...
              (m.values = function (n) {
                for (
                  var t = m.keys(n), r = t.length, e = Array(r), i = 0;
                  i < r;
                  i++
                )
                  e[i] = n[t[i]];
              ...
              (m.mapObject = function (n, t, r) {
                t = j(t, r);
                for (
                  var e = m.keys(n), i = e.length, u = {}, o = 0;
                  o < i;
                  o++
                ) {
                  var a = e[o];
              ...
              (m.invert = function (n) {
                for (var t = {}, r = m.keys(n), e = 0, i = r.length; e < i; e++)
                  t[n[r[e]]] = r[e];
                return t;
              }),
            ...
            (m.pick = x(function (n, t) {
              ...
              if (null == n) return r;
              m.isFunction(e)
                ? (t.length > 1 && (e = w(e, t[1])), (t = m.allKeys(n)))
                : ((e = C), (t = P(t, !1, !1)), (n = Object(n)));
              ...
              (m.omit = x(function (n, t) {
                ...
                return (
                  m.isFunction(e)
                    ? ((e = m.negate(e)), t.length > 1 && (r = t[1]))
                    : ((t = m.map(P(t, !1, !1), String)),
                      (e = function (n, r) {
              ...
              (H = function (n, t, r, e) {
                ...
                var u = i(n);
                return (
                  ("function" === u || "object" === u || "object" == i(t)) &&
                  K(n, t, r, e)
                );
              }),
              (K = function (n, t, r, e) {
                ...
                if ((r.push(n), e.push(t), o)) {
                  ...
                  for (; l--; ) if (!H(n[l], t[l], r, e)) return !1;
                } else {
                  var s,
                    h = m.keys(n);
                  if (((l = h.length), m.keys(t).length !== l)) return !1;
                  for (; l--; )
                    if (((s = h[l]), !_(t, s) || !H(n[s], t[s], r, e)))
                      return !1;
                }
              ...
              (m.isEmpty = function (n) {
                return (
                  null == n ||
                  (F(n) && (m.isArray(n) || m.isString(n) || m.isArguments(n))
                    ? 0 === n.length
                    : 0 === m.keys(n).length)
                );
              }),
    ...
    (() => {
      ...
      var o = r(576),
        ...
        c = function (t) {
          var r =
            ...
            h = t.getContext("2d"),
            d = function () {
              (p.x = o.random(0, t.offsetWidth)),
                (p.y = o.random(-t.offsetHeight, 0));
            },
            v = function () {
            ...
            y = function () {
              h.beginPath(),
                h.arc(p.x, p.y, p.radius, 0, 2 * Math.PI),
                (h.fillStyle = p.color),
                h.fill(),
                h.closePath();
            },
            ...
            b = function () {
              p.y < t.offsetHeight ||
                (p.isResized
                  ? (d(), (p.isResized = !1))
                  : ((p.y = 0), (p.x = o.random(0, t.offsetWidth))));
            },
            w = function () {
              m(), b();
            };
          return { update: w, resized: v, draw: g };
        },
        f =
          (document.getElementById("background_div"),
      ...
      !(function (n, t, r) {
        var e = n.getContext("2d"),
          ...
          a = function () {
            (e.canvas.width = n.offsetWidth),
              (e.canvas.height = n.offsetHeight),
              o.forEach(i, function (n) {
                return n.resized();
              });
          },
          f = function t() {
            e.clearRect(0, 0, n.offsetWidth, n.offsetHeight),
              o.forEach(i, function (n) {
                return n.draw();
              }),
              o.forEach(i, function (n) {
